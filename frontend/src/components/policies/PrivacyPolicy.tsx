    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="bg-gray-900 rounded-lg p-6 shadow-lg border border-gray-800 text-gray-300 space-y-4">
                ...
                <p>
                    We only ask for personal information when we truly need it to provide a service to you. We collect it by fair and lawful means, with your knowledge and consent. Use of your mobile number is primarily for shipping coordination and order updates.
                </p>

                <h2 className="text-xl font-semibold text-white mt-4">Data Protection</h2>
                <p>
